  ...
  return (
    <div className="bg-white">
      <section className="relative flex min-h-[500px] items-center overflow-hidden lg:min-h-[600px]">
        ...
        <div className="pointer-events-none absolute right-20 top-20 h-72 w-72 rounded-full bg-[#00afea]/10 blur-3xl" />
        <div className="pointer-events-none absolute bottom-10 left-10 h-56 w-56 rounded-full bg-[#00afea]/5 blur-2xl" />
        ...
        <div className="relative z-10 mx-auto w-full max-w-7xl px-4 py-20 sm:px-6 lg:px-8">
          <div className="max-w-2xl">
            <div className="mb-8 inline-flex items-center gap-2 rounded-full border border-white/20 bg-white/10 px-5 py-2.5 backdrop-blur-sm">
              <div className="h-2.5 w-2.5 rounded-full bg-[#00afea] animate-pulse" />
            ...
            <div className="flex flex-wrap gap-4">
              <Link
                href="/linh-vuc"
                className="group flex items-center gap-3 rounded-xl bg-[#00afea] px-8 py-4 text-lg font-bold text-white transition-all duration-300 hover:bg-[#d41111] hover:shadow-2xl hover:shadow-red-500/30"
              >
                Khám phá dịch vụ
                ...
                {timeline.map((item) => (
                  <div key={item.year} className="relative pl-12">
                    ...
                    <div className="rounded-2xl border border-slate-100 bg-white p-6 shadow-sm transition-all duration-300 hover:shadow-lg">
                      <span className="mb-3 inline-block rounded-full bg-[rgba(0, 175, 234,0.08)] px-3 py-1.5 text-xs font-bold text-[#00afea]">{item.year}</span>
          ...
          <div className="grid grid-cols-2 gap-8 lg:grid-cols-4">
            {stats.map((stat) => (
              <div key={stat.label} className="group text-center">
                <div className="mb-2 text-4xl font-black text-[#00afea] transition-transform duration-300 group-hover:scale-110 lg:text-5xl">
                  {stat.value}
                </div>
      ...
      <section className="relative overflow-hidden bg-[#0F172A] py-20 lg:py-28">
        <div className="pointer-events-none absolute inset-0 bg-gradient-to-br from-[#00afea]/10 to-transparent" />
        <div className="relative mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="mx-auto mb-10 max-w-4xl">
            <div className="rounded-2xl border border-white/10 bg-white/5 p-12 text-center backdrop-blur-sm transition-all duration-300 hover:border-[#00afea]/30 hover:bg-white/10">
              <div className="mb-8 flex justify-center">
                <div className="flex h-16 w-16 items-center justify-center rounded-2xl bg-[#00afea] text-white">
        ...
        <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
          ...
          <div className="grid grid-cols-1 gap-6 lg:grid-cols-3">
            {businessPillars.map((item, index) => (
              <div
                key={item.title}
                className="group relative overflow-hidden rounded-2xl border border-slate-100 bg-white p-8 shadow-sm transition-all duration-300 hover:-translate-y-1 hover:border-[#00afea]/20 hover:shadow-xl"
              >
                <div className="absolute inset-x-0 bottom-0 h-1 bg-[#00afea]" />
                <div className="mb-6 flex h-12 w-12 items-center justify-center rounded-xl bg-[rgba(0, 175, 234,0.08)] text-lg font-black text-[#00afea]">
          ...
          <div className="mt-14 grid grid-cols-1 gap-8 lg:grid-cols-[0.95fr_1.35fr]">
            <div className="relative overflow-hidden rounded-3xl bg-[#0F172A] p-8 text-white lg:p-10">
              <div className="pointer-events-none absolute right-0 top-0 h-48 w-48 translate-x-1/3 -translate-y-1/3 rounded-full bg-[#00afea]/20" />
              <div className="relative">
                ...
                <Link
                  href="/linh-vuc"
                  className="inline-flex items-center gap-3 rounded-xl bg-[#00afea] px-6 py-3 font-bold text-white transition-colors hover:bg-[#d41111]"
                >
          ...
          <div className="mt-14 rounded-3xl border border-[#00afea1a] bg-white p-8 shadow-sm lg:p-10">
            <div className="grid grid-cols-1 gap-8 lg:grid-cols-[0.8fr_1.2fr] lg:items-center">
              <div>
                <div className="mb-4 inline-flex items-center gap-2 rounded-full bg-[rgba(0, 175, 234,0.08)] px-4 py-2">
                  <div className="h-1.5 w-1.5 rounded-full bg-[#00afea]" />
                  <span className="text-xs font-bold uppercase tracking-widest text-[#00afea]">Cam kết phát triển</span>
                </div>
              ...
              <div className="space-y-4">
                {companyCommitments.map((item) => (
                  <div key={item} className="flex gap-4 rounded-2xl bg-[#FAFAFA] p-4">
                    <span className="mt-1 flex h-5 w-5 shrink-0 items-center justify-center rounded-full bg-[#00afea] text-xs font-bold text-white">✓</span>
      ...
      <section className="bg-white py-20">
        <div className="mx-auto max-w-5xl px-4 sm:px-6 lg:px-8">
          <div className="relative overflow-hidden rounded-3xl bg-gradient-to-br from-[#00afea] to-[#103faa] p-12 text-white shadow-2xl shadow-blue-200/50 lg:p-16">
            ...
            <div className="relative text-center">
              ...
              <div className="flex flex-col items-center justify-center gap-4 sm:flex-row">
                <a
                  href="mailto:hcns.byd@gmail.com"
                  className="w-full rounded-xl bg-white px-8 py-4 text-center text-lg font-bold text-[#00afea] shadow-lg transition-colors hover:bg-red-50 sm:w-auto"
                >
                  Trao đổi hợp tác
                </a>
                <Link
