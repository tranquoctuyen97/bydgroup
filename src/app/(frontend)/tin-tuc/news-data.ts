...
export const fallbackNews: NewsItem[] = [
  ...
  },
  {
    ...
    author: 'Thành Công 45 Media',
  },
  {
    id: 3,
    img: '/images/sinh-nhat-van-phong.webp',
    tag: 'Văn hóa',
    title: 'Cầu lông Thành Công 45 – Cháy hết mình sau giờ làm 🏸',
    ...
    content: 'Không chỉ hết mình trong công việc, các thành viên Thành Công 45 còn cháy hết mình trên sân cầu lông 🏸🔥\n\nNhững trận đấu đầy năng lượng, những pha cầu "căng đét" cùng vô số tiếng cười đã tạo nên một buổi chiều cực kỳ đáng nhớ. Không quan trọng thắng thua, quan trọng là anh em được vận động, xả stress và gắn kết với nhau hơn sau giờ làm 💪\n\nGia nhập Thành Công 45 để không chỉ phát triển sự nghiệp và còn có những khoảng thời gian "cháy" hết mình cùng đồng đội như thế này nhé! 🚀',
    author: 'HR Team',
  },
  {
    id: 4,
  ...
  },
  {
    ...
    content: 'Chuyến Team Building Cửa Lò 2025 đã diễn ra thật tuyệt vời! 🎉\n\nToàn bộ đội ngũ Thành Công 45 đã cùng nhau tham gia các hoạt động gắn kết, chia sẻ và tạo nên những kỷ niệm đáng nhớ.\n\nĐây là minh chứng cho tinh thần Đoàn Kết – một trong những giá trị cốt lõi mà Thành Công 45 luôn theo đuổi. Mỗi chuyến đi là cơ hội để anh em hiểu nhau hơn, gắn kết hơn và cùng nhau tiến về phía trước! 🚀',
    author: 'HR Team',
  },
  {
    id: 6,
    ...
    tag: 'Sự kiện',
    title: 'Happy Men\'s Day – Ngày nam giới Thành Công 45 🎉',
    desc: 'Thành Công 45 chúc mừng ngày nam giới – cảm ơn các anh em đã luôn đồng hành và cống hiến!',
    date: '19 Tháng 11, 2024',
    content: 'Happy Men\'s Day! 🎉\n\nThành Công 45 gửi lời chúc mừng tới toàn thể các anh em trong công ty nhân ngày Quốc tế Nam giới 19/11!\n\nCảm ơn các anh em đã luôn nỗ lực, cống hiến và là trụ cột vững chắc của đội ngũ Thành Công 45. Chúc các anh em luôn mạnh mẽ, thành công và hạnh phúc! 💪',
    author: 'Thành Công 45 Media',
  },
]
