        ...
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 flex items-center justify-between h-9">
          ...
          <div className="flex items-center gap-4">
            <a
              ...
              aria-label="Facebook Thành Công 45"
            ...
            <a
              ...
              target="_blank"
              rel="noopener noreferrer"
              aria-label="TikTok Thành Công 45"
              className="hover:text-red-100 transition-colors"
            >
      ...
      >
        <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
          <div className="flex items-center justify-between h-18 lg:h-20">
            <Link href="/" aria-label="Trang chủ Thành Công 45" className="flex items-center gap-3 shrink-0">
              <img src="/images/thanh-cong-45-logo.png" alt="Thành Công 45 Logo" className="h-10 lg:h-12 w-auto" loading="eager" decoding="async" width="160" height="48" />
            </Link>
